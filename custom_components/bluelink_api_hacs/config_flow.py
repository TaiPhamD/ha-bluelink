...
class BluelinkFlowBase:
    ...
    async def handle_login_and_vehicle_selection(self, user_input):
    ...
    async def _common_step(self, user_input, step_id):
        """Common step logic for user and options flow."""
        if user_input is not None:
            return await self.handle_login_and_vehicle_selection(user_input)
...
class BluelinkOptionsFlowHandler(BluelinkFlowBase, config_entries.OptionsFlow):
    ...
    async def async_step_init(self, user_input=None):
        ...
        if user_input is not None:
            result = await self._common_step(user_input, "user")
        ...
        return self.async_show_form(
            step_id="init",
            data_schema=DATA_SCHEMA,  # Adjust this schema as per your options
        )
...
class BluelinkConfigFlow(BluelinkFlowBase, config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_user(self, user_input=None):
        ...
        return await self._common_step(user_input, "user")
